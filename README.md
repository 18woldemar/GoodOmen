...
| `tools/tex2png.py` | Converts `.tex` textures to PNG. |
...
| `.tex` | A **DXT1** mip chain, largest level first, down to 8×8; the trailing 84 bytes hold the 4×4/2×2/1×1 levels as raw RGBA. Fonts are stored uncompressed. |
...
- [ ] **M2** Every texture converts to PNG without artefacts
